...
<b>Standard User Account:</b><ul>
<li>Account used for day to day activities, such as checking email, internet access, etc.</li>  
<li>This is a non-privileged account</li></ul>

<b>Administrator Account:</b><ul>
...
<li>Should not be used to log into or administer workstations</li></ul>
